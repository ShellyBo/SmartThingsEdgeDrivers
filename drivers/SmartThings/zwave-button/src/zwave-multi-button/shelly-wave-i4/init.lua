...
local ZWAVE_WAVE_i4_FINGERPRINTS = {
  {mfr = 0x0460, prod = 0x0009, model = 0x0081}, -- Shelly Wave i4
  {mfr = 0x0460, prod = 0x0009, model = 0x0082}  -- Shelly Wave i4 DC
}

local function can_handle_wave_i4(opts, driver, device, ...)
  for _, fingerprint in ipairs(ZWAVE_WAVE_i4_FINGERPRINTS) do
